...
#* Init
    ...
    def eventFilter(self, target, event):
        """ Key presses aren't widget specific, so they're handled by the window
            This function just passes any key inputs onto the Paper
        """
...
#* Toolbar
    ...
    def createToolbar(self):
        ...
        self.colorDock = self.addToolBar("")

        #* Configure the toolbar setup
        self.colorDock.setLayout(QHBoxLayout())
        self.colorDock.layout().setSpacing(25)
